...
@click.option("--logfolder", "-l",
              ...
              default=None,
              type=click.Path(resolve_path=True))
def multi10x(parentfolder: str, gtffile: str,
             number: int, wait: int,
             metadatatable: str, logic: str, repmask: str, introns: str, molrep: bool,
             logfolder: str) -> None:
    ...
    for dir_i in all_10X_dirs:
        ...
        if list_loom == [] and not os.path.exists(name_log_file):
            ...
            arguments = ["nohup", "velocyto", "run10x", f"{folder}", f"{gtffile}"]
            if metadatatable:
