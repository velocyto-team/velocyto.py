...
The logic module offers the possibility to user to easily change the logic used to count "spliced", "unspliced", "ambiguous" molecules, without requiring a complete rewrite of the all pipeline.
